...
class ShareApprovalShareFilter implements IFilter {
	/** @var IL10NFactory */
	private $l10nFactory;
	/** @var IURLGenerator */
	...
	public function getIdentifier() {
		return 'webhooks_share_approval_share';
	}

	public function getName() {
		return $this->l10nFactory->get(Application::APP_ID)->t('文件分享审批');
	}
	...
	public function filterTypes(array $types) {
		return [ShareApprovalProvider::TYPE_SHARE];
	}
